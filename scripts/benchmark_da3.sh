...
manifest_path="$OUT_DIR/da3_coverage_manifest.json"
log_path="$OUT_DIR/da3.log"
analyzer_path="$OUT_DIR/model_analyzer.log"
...
python3 - "$OUT_DIR" "$VIDEO" "$MEMORY_CEILING_BYTES" <<'PY'
import json
import re
import sys
...
summary = {
    ...
    "manifest_points": manifest.get("fused_sparse_point_count"),
    "manifest_observations": manifest.get("final_observation_count"),
