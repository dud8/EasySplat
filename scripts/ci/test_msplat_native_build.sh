...
require_contains 'RASTER_TEST_SHA256="2117e15eda637952a3481fb01da8c8f0cdb5629830344e84486fa5f094a09dc7"' "$BUILD_SCRIPT"
...
for contract_file in "$SWIFT_VALIDATOR" "$SWIFT_FIXTURE"; do
  ...
  require_contains '"raster_test_sha256": "2117e15eda637952a3481fb01da8c8f0cdb5629830344e84486fa5f094a09dc7"' "$contract_file"
