...
require_contains 'EXACT_PREFIX_HARDENING_PATCH_SHA256="e7437861085e86e8671898b8c5833568e0420bdf1c0559175ddcdb34ed159ace"' "$BUILD_SCRIPT"
actual_exact_prefix_hardening_patch_sha256="$(shasum -a 256 "$EXACT_PREFIX_HARDENING_PATCH" | awk '{print $1}')"
[ "$actual_exact_prefix_hardening_patch_sha256" = "e7437861085e86e8671898b8c5833568e0420bdf1c0559175ddcdb34ed159ace" ] \
