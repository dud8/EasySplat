...
The private 250-view DJI regression completed in 260.55 seconds on the same machine, down from the original 1,262-second app run. Prepare took 15.06 seconds; SIFT, matching, and mapping took 134.76 seconds; native training took 110.73 seconds. It registered 250/250 views with 79,107 points, 965,239 observations, a 0.37 px median residual, and a 1.29 px p90 residual. Geometry and training peaked at 2.72 GB and 3.68 GB respectively. Canonical orientation resolved as verified. This is a 4.84× same-capture speedup, but it remains private regression evidence rather than corpus proof.
